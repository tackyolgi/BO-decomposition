...
saveRDS(B_regr_ordered, file="./models/B_regr_ordered_2008_95.RData")
saveRDS(B_RF_female_ordered, file="./models/B_RF_female_ordered_2008_95.RData")
saveRDS(B_RF_male_ordered, file="./models/B_RF_male_ordered_2008_95.RData")
...
# results
results_RF <- as.data.frame( (cbind( ev=mean(minta$train$ev), nyers=round(raw,4), 
...
# save
saveRDS(minta, file="./data/minta_2008_95.RData")
