...
saveRDS(B_regr_ordered, file="./models/B_regr_ordered_2009_95.RData")
saveRDS(B_RF_female_ordered, file="./models/B_RF_female_ordered_2009_95.RData")
saveRDS(B_RF_male_ordered, file="./models/B_RF_male_ordered_2009_95.RData")
...
# save
saveRDS(minta, file="./data/minta_2009_95.RData")
