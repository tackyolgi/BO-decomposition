...
saveRDS(B_regr_ordered, file="B_regr_ordered_2014.RData")
saveRDS(B_RF_female_ordered, file="B_RF_female_ordered_2014.RData")
saveRDS(B_RF_male_ordered, file="B_RF_male_ordered_2014.RData")

# unexplaind part
# RF

B_RF_female_ordered <- readRDS("B_RF_female_ordered_2014.RData")
B_RF_male_ordered <- readRDS("B_RF_male_ordered_2014.RData")
...
saveRDS(minta, file="minta_2014.RData")
