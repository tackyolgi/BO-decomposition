...
minta <- readRDS("./data/minta_09.RData")
...
saveRDS(B_regr_ordered, file="./models/B_regr_ordered_2009.RData")
saveRDS(B_RF_female_ordered, file="./models/B_RF_female_ordered_2009.RData")
saveRDS(B_RF_male_ordered, file="./models/B_RF_male_ordered_2009.RData")
...
# save
saveRDS(minta, file="./data/minta_2009.RData")
