...
minta <- readRDS("./data/minta_15.RData")
...
saveRDS(B_regr_ordered, file="./models/B_regr_ordered_2015.RData")
saveRDS(B_RF_female_ordered, file="./models/B_RF_female_ordered_2015.RData")
saveRDS(B_RF_male_ordered, file="./models/B_RF_male_ordered_2015.RData")
...
# save
saveRDS(minta, file="./data/minta_2015.RData")
