...
saveRDS(B_regr_ordered, file="B_regr_ordered_2015_95.RData")
saveRDS(B_RF_female_ordered, file="B_RF_female_ordered_2015_95.RData")
saveRDS(B_RF_male_ordered, file="B_RF_male_ordered_2015_95.RData")

# unexplaind part
# RF

B_RF_female_ordered <- readRDS("B_RF_female_ordered_2015_95.RData")
B_RF_male_ordered <- readRDS("B_RF_male_ordered_2015_95.RData")
...
# save
setwd("C:/Users/tacky/OneDrive - Corvinus University of Budapest/phd/research/technical note/data")
saveRDS(minta, file="minta_2015_95.RData")
