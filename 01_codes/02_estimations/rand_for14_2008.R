...
saveRDS(B_RF_female_ordered, file="B_RF_female_ordered_2008.RData")
saveRDS(B_RF_male_ordered, file="B_RF_male_ordered_2008.RData")

# unexplaind part
# RF

B_RF_female_ordered <- readRDS("B_RF_female_ordered_2008.RData")
B_RF_male_ordered <- readRDS("B_RF_male_ordered_2008.RData")
...
# results
results_RF <- as.data.frame( (cbind(modszer="RF", ev=mean(minta$train$ev), nyers=raw, magyarazott=expl, 
...
# save
setwd("C:/Users/tacky/OneDrive - Corvinus University of Budapest/phd/research/technical note/data")
saveRDS(minta, file="minta_2008.RData")
