...
setwd("C:/Users/tacky/OneDrive - Corvinus University of Budapest/phd/research/technical note/data")
 ...
 write.csv(data_08, "tarifa2008.csv")
 write.csv(data_09, "tarifa2009.csv")
 write.csv(data_10, "tarifa2010.csv")
 write.csv(data_11, "tarifa2011.csv")
 write.csv(data_12, "tarifa2012.csv")
 write.csv(data_13, "tarifa2013.csv")
 write.csv(data_14, "tarifa2014.csv")
 write.csv(data_15, "tarifa2015.csv")
 write.csv(data_16, "tarifa2016.csv")

data_08 <- read.csv("tarifa2008.csv")
data_09 <- read.csv("tarifa2009.csv")
data_10 <- read.csv("tarifa2010.csv")
data_11 <- read.csv("tarifa2011.csv")
data_12 <- read.csv("tarifa2012.csv")
data_13 <- read.csv("tarifa2013.csv")
data_14 <- read.csv("tarifa2014.csv")
data_15 <- read.csv("tarifa2015.csv")
data_16 <- read.csv("tarifa2016.csv")
...
source('C:/Users/tacky/OneDrive - Corvinus University of Budapest/phd/research/technical note/01_codes/01_data loading/female_percent_in_feor.R', encoding = 'UTF-8')
library(dplyr)
...
# excluding NA-s
source("C:/Users/tacky/OneDrive - Corvinus University of Budapest/phd/research/technical note/01_codes/01_data loading/torles.R")
...
# factors
source("C:/Users/tacky/OneDrive - Corvinus University of Budapest/phd/research/technical note/01_codes/01_data loading/faktorizalas_ordered.R")
...
saveRDS(minta_08, "minta_08.RData")
saveRDS(tarifred_08, "tarifred_08.RData")

minta_09 <- get_sample(tarifred_09, obs_num)
saveRDS(minta_09, "minta_09.RData")
saveRDS(tarifred_09, "tarifred_09.RData")

minta_10 <- get_sample(tarifred_10, obs_num)
saveRDS(minta_10, "minta_10.RData")
saveRDS(tarifred_10, "tarifred_10.RData")

minta_11 <- get_sample(tarifred_11, obs_num)
saveRDS(minta_11, "minta_11.RData")
saveRDS(tarifred_11, "tarifred_11.RData")

minta_12 <- get_sample(tarifred_12, obs_num)
saveRDS(minta_12, "minta_12.RData")
saveRDS(tarifred_12, "tarifred_12.RData")

minta_13 <- get_sample(tarifred_13, obs_num)
saveRDS(minta_13, "minta_13.RData")
saveRDS(tarifred_13, "tarifred_13.RData")

minta_14 <- get_sample(tarifred_14, obs_num)
saveRDS(minta_14, "minta_14.RData")
saveRDS(tarifred_14, "tarifred_14.RData")

minta_15 <- get_sample(tarifred_15, obs_num)
saveRDS(minta_15, "minta_15.RData")
saveRDS(tarifred_15, "tarifred_15.RData")

minta_16 <- get_sample(tarifred_16, obs_num)
saveRDS(minta_16, "minta_16.RData")
saveRDS(tarifred_16, "tarifred_16.RData")
